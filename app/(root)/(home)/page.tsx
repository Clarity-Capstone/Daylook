        ...
        <div className="h-[300px] w-full rounded-[20px] bg-link bg-cover">
          <div className="flex h-full flex-col justify-between max-md:px-5 max-md:py-8 lg:p-11">
            ...
            <div className="flex flex-col gap-2">
              ...
              <p className="text-lg font-medium text-yellow-400/25 dark:text-yellow-400/25 lg:text-2xl transition-all duration-1000 ease-in-out hover:text-yellow-600/75 dark:hover:text-yellow-400/75">{date}</p>
            </div>
          </div>
        </div>
